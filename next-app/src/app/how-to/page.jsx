...
const HowToPage = () => {
  const steps = [
    ...
    {
      emoji: "🌐",
      title: "Switch to Sepolia Test Network",
      description:
        "Add the Sepolia network in Metamask, connect, and prepare to interact with the blockchain.",
    },
    {
      emoji: "💸",
      title: "Get Test ETH from Faucet",
      description:
        "Request free test ETH from a Sepolia faucet to enable transactions on the test network.",
    },
    {
      emoji: "📜",
    ...
    },
    {
      ...
      description:
        "Track your transactions and details on Sepolia Etherscan to understand the blockchain better.",
    },
  ];
    ...
    <div className="bg-gray-50 flex flex-col justify-center items-center min-h-screen">
      <div className="px-6 py-10 max-w-5xl w-full text-center">
        ...
        <p className="text-lg text-gray-600 mb-8">
          ...
          Sepolia test network, and interact with blockchain smart contracts.
        </p>
